...
Un altro esempio potrebbe essere il caso in cui $a$ = "camminare", in questo caso, essendo che l'atto non è un'azione che coinvolge altre persone, $(i,a,C)$ potrebbe essere un potere nell'unico caso in cui $C=\empty$, altrimenti non avrebbe senso. 
